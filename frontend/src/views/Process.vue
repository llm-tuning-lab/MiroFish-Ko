    ...
    <div class="main-content">
      ...
      <div class="left-panel" :class="{ 'full-screen': isFullScreen }">
        ...
        <div class="graph-container" ref="graphContainer">
          ...
          <div v-else-if="graphLoading" class="graph-loading">
            ...
            <p class="loading-text">그래프 데이터 불러오는 중...</p>
          </div>
          ...
          <div v-else-if="currentPhase < 1" class="graph-waiting">
            ...
            <p class="waiting-hint">생성이 완료되면 그래프 구축을 자동으로 시작합니다</p>
          </div>
          ...
          <div v-else-if="currentPhase === 1 && !graphData" class="graph-waiting">
            ...
            <p class="waiting-hint">곧 데이터가 표시됩니다...</p>
          </div>
      ...
      <div class="right-panel" :class="{ 'hidden': isFullScreen }">
        <div class="panel-header dark-header">
          ...
          <span class="header-title">구축 절차</span>
        </div>
            ...
            <div class="phase-detail">
              <div class="detail-section">
                ...
                <div class="detail-content">
                  문서를 업로드하면 LLM이 내용을 분석해 여론 시뮬레이션에 맞는 온톨로지 구조(엔터티 유형 + 관계 유형)를 자동 생성합니다
                </div>
              </div>
              ...
              <div class="detail-section" v-if="projectData?.ontology">
                <div class="detail-label">생성된 엔터티 유형 ({{ projectData.ontology.entity_types?.length || 0 }})</div>
              ...
              <div class="detail-section" v-if="projectData?.ontology">
                ...
                <div class="relation-list">
                  ...
                  <div v-if="(projectData.ontology.relation_types?.length || 0) > 5" class="relation-more">
                    +{{ projectData.ontology.relation_types.length - 5 }} 개 더
                  </div>
                </div>
              </div>
          ...
          <div class="process-phase" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
            ...
            <div class="phase-detail">
              <div class="detail-section">
                <div class="detail-label">API 설명</div>
                <div class="detail-content">
                  생성된 온톨로지를 기반으로 문서를 분할하고 Zep API를 호출해 지식 그래프를 구축하며 엔터티와 관계를 추출합니다
                </div>
              </div>
              ...
              <div class="detail-section" v-if="graphData">
                ...
                <div class="build-result">
                  <div class="result-item">
                    ...
                    <span class="result-label">엔터티 노드</span>
                  </div>
                  <div class="result-item">
                  ...
                  <div class="result-item">
                    ...
                    <span class="result-label">엔터티 유형</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="process-phase" :class="{ 'active': currentPhase === 2, 'completed': currentPhase > 2 }">
            <div class="phase-header">
              ...
              <div class="phase-info">
                ...
                <div class="phase-api">다음 단계로 이동할 준비 완료</div>
              </div>
  ...
  try {
    ...
    if (response.success) {
      ...
      if (task.status === 'completed') {
        console.log('✅ 그래프 구축 완료, 전체 데이터를 불러오는 중...')
        ...
        stopPolling()
        stopGraphPolling()
        error.value = '그래프 구축실패: ' + (task.error || '알 수 없는 오류')
        buildProgress.value = null
      }
    }
  } catch (err) {
